...
public class ComplexRenovationService
{
    ...
    public bool AddComplexRenovation(ComplexRenovation complexRenovation)
    {
        ...
        new ComplexRenovationRepository(SerializerInjector.CreateInstance<ISerializer<ComplexRenovation>>()).Add(
            complexRenovation);
        return true;
    }
    ...
    {
        foreach (var complexRenovation in new ComplexRenovationRepository(SerializerInjector
                     .CreateInstance<ISerializer<ComplexRenovation>>()).GetAll())
        {
