...
{
    private readonly ExaminationRecommenderService _examinationService;
    ...
    private void Find()
    {
        ...
        var options = new ExaminationSearchOptions(SelectedDoctor, LatestDate.Value, startTime, endTime,
