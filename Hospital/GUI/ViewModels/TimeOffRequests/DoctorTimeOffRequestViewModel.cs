...
public class DoctorTimeOffRequestViewModel : ViewModelBase
{
    ...
    {
        TimeOffRequests =
            new ObservableCollection<DoctorTimeOffRequest>(
                new DoctorTimeOffRequestRepository(
                    SerializerInjector.CreateInstance<ISerializer<DoctorTimeOffRequest>>()).GetAll());
