...
public class PatientRepositoryTests
{
    ...
    public void TestInitialize()
    {
        ...
        if (File.Exists(examinationFilePath)) File.Delete(examinationFilePath);

        var testPatients = new List<Patient>
        {
            new("Vladimir", "Popov", "0123456789012", "vlada1234", "vlada1234",
                new MedicalRecord(175, 70, new List<string> { "penicillin", "sulfa", "aspirin" },
                    new List<string> { "mental illness", "cold" })),
            new("Momir", "Milutinovic", "0123456789012", "momir1234", "momir1234",
                new MedicalRecord(176, 71, new List<string> { "penicillin", "sulfa", "aspirin" },
                    new List<string> { "mental illness", "cold" })),
            new("Balsa", "Bulatovic", "0123456789012", "balsa1234", "balsa1234",
                new MedicalRecord(177, 72, new List<string> { "penicillin", "sulfa", "aspirin" },
                    new List<string> { "mental illness", "cold" })),
            new("Teodor", "Vidakovic", "0123456789012", "teodor1234", "teodor1234",
                new MedicalRecord(178, 73, new List<string> { "penicillin", "sulfa", "aspirin" },
                    new List<string> { "mental illness", "cold" }))
        };
    ...
    public void TestGetById()
    {
        ...
        Assert.AreEqual(testPatient.MedicalRecord.MedicalHistory.Conditions.Count,
            patientRepository.GetById(testPatient.Id)?.MedicalRecord.MedicalHistory.Conditions.Count);
    }
    ...
    public void TestUpdate()
    {
        ...
        Assert.AreEqual("testAllergy",
            patientRepository.GetById(testPatient.Id)?.MedicalRecord.Allergies.Conditions[0]);
    }
    ...
    public void TestAdd()
    {
        var newPatient = new Patient("TestFirstName", "TestLastName", "1234567890123",
            "testUsername",
    ...
    public void TestUpdateNonExistent()
    {
        ...
        Assert.ThrowsException<KeyNotFoundException>(() => patientRepository.Update(new Patient()));
    }
    ...
    public void TestDeleteNonExistent()
    {
        ...
        Assert.ThrowsException<KeyNotFoundException>(() => patientRepository.Delete(new Patient()));
    }
}