...
namespace HospitalTests.Repositories.Examination
{
    ...
    public class ExaminationRepositoryTests
    {
        ...
        private void CreateTestExaminationRepository()
        {
            ...
            var doctor1 = new Doctor("Dr. Emily", "Brown", "1234567890121", "dremilybrown", "docpassword1","hirurgija");
            var doctor2 = new Doctor("Dr. Jake", "Wilson", "1234567890122", "drjakewilson", "docpassword2","mikrobiologija");
        ...
        {
            var doctor = new Doctor("Dr. Linda", "Miller", "1234567890123", "drlindamiller", "docpassword3", "hirurgija");
